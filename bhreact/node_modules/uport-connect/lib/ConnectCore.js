...
var ConnectCore = function () {
  ...
  function ConnectCore(appName) {
    ...
    if (opts.clientId) this.clientId = (0, _mnid.isMNID)(opts.clientId) ? opts.clientId : (0, _mnid.encode)({ network: '0x3', address: opts.clientId });
  ...
  _createClass(ConnectCore, [{
    ...
    value: function attestCredentials(_ref, uriHandler) {
      ...
      return this.credentials.attest({ sub: sub, claim: claim, exp: exp }).then(function (jwt) {
        return _this2.request({ uri: 'me.uport:add?attestations=' + encodeURIComponent(jwt) + '&callback_url=' + encodeURIComponent(topic.url), topic: topic, uriHandler: uriHandler });
      });
    }
